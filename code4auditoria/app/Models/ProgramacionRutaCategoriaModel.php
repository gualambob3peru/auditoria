...
class ProgramacionRutaCategoriaModel extends Model
{
    protected $DBGroup              = 'default';
    protected $table                = 'programacion_ruta_categoria';
    ...
    protected $allowedFields        = ['id_programacion_ruta','id_local','id_categoria','id_frecuencia','estado'];
