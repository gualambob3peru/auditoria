<div class="container">
    ...
    <form action="" method="POST">
            ...
            <div class="col-sm-10">
                <select name="personal" class="form-select" id="personal">
                    ...
                    <?php foreach ($personals as $key => $value) : ?>
                        <option  value="<?= $value["id"] ?>"><?= $value["nombres"]." ".$value["apellidoPaterno"]." ".$value["apellidoMaterno"] ?></option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="col-sm-10">
                <select name="ruta" class="form-select" id="ruta">
                    ...
                    <?php foreach ($rutas as $key => $value) : ?>
                        <option  value="<?= $value["id"] ?>"><?= $value["r_descripcion"] ?></option>
                    <?php endforeach; ?>
                </select>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="date" name="fecha_visita" class="form-control" id="fecha_visita" value="" required>
