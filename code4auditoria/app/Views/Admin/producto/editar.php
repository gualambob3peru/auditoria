<div class="container">
    ...
    <form action="" method="POST">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" name="sku" class="form-control" id="sku" value="<?= $f_model["sku"] ?>" required>
            ...
            <div class="col-sm-10">
                <select name="magnitud" class="form-select" id="magnitud">
                    ...
                    <?php foreach($magnitudes as $key=>$value): ?>
                        ...
                        <option <?php echo (($value["id"] == $f_model["id_magnitud"])?"selected":"") ?> value="<?= $value["id"] ?>"><?= $value["descripcion"] ?></option>
                    <?php endforeach; ?>
                </select>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" name="valor" class="form-control" id="valor" value="<?= $f_model["valor"] ?>" required>
