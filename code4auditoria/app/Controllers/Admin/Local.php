...
class Local extends BaseController
{
    private $db = "";
    private $table = "local";
    private $nombre = "local";
    private $lista = "locals";
    private $dataView = [];
    private $model = "";
    ...
    {
        $lista_datos = $this->db->table("local l")
            ->select("l.id,l.descripcion,l.id_canal, c.descripcion c_descripcion, l.id_zona, z.descripcion z_descripcion,l.id_tipo_via, tv.descripcion tv_descripcion, l.ruc,l.nombre_via,l.numero,l.lat,l.lgn")
